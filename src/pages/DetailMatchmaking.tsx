        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          ...
          <div className="w-full md:w-[240px] shrink-0">
            <FadeIn>
              ...
              <a href="https://gwansang-test.vercel.app/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#4a5568] hover:bg-[#2d3748] text-white px-6 py-3.5 text-sm font-bold transition-colors shadow-sm w-full md:w-auto">
