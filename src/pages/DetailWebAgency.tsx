import { IconBrowser, IconArrowRightCircle } from '@tabler/icons-react';
import FadeIn from '../components/FadeIn';

export default function DetailWebAgency() {
  return (
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="flex flex-col md:flex-row gap-12 md:gap-16">
          ...
          <div className="w-full md:w-[240px] shrink-0">
            <FadeIn>
              <div className="text-[#3b4859] font-bold mb-4 text-sm uppercase tracking-widest">Service.03</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3 leading-snug">
                고성능 웹사이트 제작<br/>웹 에이전시
              </h2>
              <div className="text-sm text-gray-500 mb-10">Since 2023.08</div>
              
              <a href="https://project113-azure.vercel.app/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#4a5568] hover:bg-[#2d3748] text-white px-6 py-3.5 text-sm font-bold transition-colors shadow-sm w-full md:w-auto">
          ...
          <div className="flex-1">
            <FadeIn delay={0.2}>
              ...
              <p className="text-[15px] text-gray-600 leading-[1.8] whitespace-pre-wrap">
                비즈니스 목표를 달성하는 고성능 웹사이트 제작. 사용자 중심의 디자인과 최신 기술로 브랜드의 디지털 경쟁력을 높입니다. 반응형 웹, SEO 최적화, 빠른 로딩 속도를 보장합니다.
              </p>
            </FadeIn>
          </div>
        </div>
